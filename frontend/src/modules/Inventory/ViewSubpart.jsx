...
function ViewSubpart({ authrztn }) {
  ...
  useEffect(() => {
    axios
      .get(BASE_URL + "/inventory/fetchWarehouseInvetory_subpart", {
        params: {
          id: id,
        },
      })
  ...
  useEffect(() => {
    const delay = setTimeout(() => {
      // console.log('code' + id)
      axios
        .get(BASE_URL + "/inventory/fetchView_subpart", {
          params: {
            id: id,
          },
        })
        .then((res) => {
          setCode(res.data[0].subPart_code);
          setName(res.data[0].subPart_name);
          setCategory(res.data[0].category.category_name);
          setBinLocation(res.data[0].binLocation.bin_subname);
          setUm(res.data[0].subPart_unitMeasurement);
          setDetails(res.data[0].subPart_desc);
