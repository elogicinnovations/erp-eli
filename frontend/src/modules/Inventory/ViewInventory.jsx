...
function ViewInventory({authrztn}) {
  ...
  useEffect(() => {
    ...
    // console.log('code' + id)
    axios.get(BASE_URL + '/inventory/fetchView', {
        params: {
          id: id
        }
      })
    .then(res => {
        setCode(res.data[0].product_tag_supplier.product.product_code);
        setName(res.data[0].product_tag_supplier.product.product_name);
        setPrice(res.data[0].product_tag_supplier.product_price);
