...
function StockManagement({ authrztn }) {
  ...
  const [rotatedIcons, setRotatedIcons] = useState(
    Array(stockMgnt.length).fill(false)
  );
  ...
  const handleRejustify = async (stock_id) => {
    try {
      ...
      const res = await axios.get(
        BASE_URL + "/StockTransfer/fetchRejustifyRemarks",
        {
  ...
  const handleRowToggle = async (stock_id) => {
    try {
      const res = await axios.get(
        BASE_URL + "/StockTransfer/fetchdropdownData",
        {
          params: { stock_id: stock_id },
        }
      );
      ...
      setOpenRows((prevOpenRow) =>
        prevOpenRow === stock_id ? null : stock_id
      );
    } catch (err) {
      console.error(err);
    }
      ...
      if (willDelete) {
        try {
          const response = await axios.delete(
            BASE_URL + `/stockTransfer/delete/${id}?userId=${userId}`
          );
      ...
      <div className="right-of-main-containers">
        {isLoading ? (
          ...
          <div className="right-body-contents">
            <div className="settings-search-master"></div>
            <div className="Employeetext-button">
              <div className="employee-and-button">
                ...
                <div className="button-create-side">
                  ...
                  <div className="Buttonmodal-new div-fade"></div>
                </div>
                ...
                <div className="btn-and-search">
                  {authrztn?.includes("Stock Management - Add") && (
                    <div className="button-create-side">
                      <div className="Buttonmodal-new">
                        <Link
                          to="/createStockTransfer"
                          className="button stck-tranf"
                        >
                          <span style={{}}>
                            <Plus size={25} />
                            Stock Transfer
