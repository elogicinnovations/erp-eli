  ...
  return (
    <div class="container-cpass">
      <head>
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css?family=Poppins%3A300%2C400%2C500%2C600%2C700%2C900"
        />
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css?family=Source+Sans+Pro%3A300%2C400%2C500%2C600%2C700%2C900"
        />
        <link rel="stylesheet" href="./styles/forgot-password-dXo.css" />

        <link
          rel="stylesheet"
          href="https://demo.bootstrapdash.com/skydash/template/vendors/feather/feather.css"
        />
        <link
          rel="stylesheet"
          href="https://demo.bootstrapdash.com/skydash/template/vendors/ti-icons/css/themify-icons.css"
        />
        <link
          rel="stylesheet"
          href="https://demo.bootstrapdash.com/skydash/template/vendors/css/vendor.bundle.base.css"
        />
        <link
          rel="stylesheet"
          href="https://demo.bootstrapdash.com/skydash/template/vendors/jquery-toast-plugin/jquery.toast.min.css"
        />
      </head>
      ...
      <div className="confirm-pass-right">
        <div className="cpass-box-container">
          <div className="cpass-white-box">
            <p className="setup-text">Set up new Password</p>
            ...
            <div style={{userSelect: 'none', width: 'max-content'}} className="backto-Otp">
              <Link
                to="/OTP"
                style={{ display: "contents", background: "red", fontSize: 18, color: "orange" }}
              >
