...
const StyledInputElement = styled("input")(
  ...
  &:focus {
    ...
    box-shadow: 0 0 0 3px ${
      theme.palette.mode === "dark" ? inputblue[500] : inputblue[200]
    };
  }
...
function OTP() {
  ...
  return (
    <div class="main-onetimepass">
      <div className="otpass-blurd"></div>

      <div className="otp-lefts"></div>

      <div className="right-otpass">
        <div className="otp-rightbox">
          <div className="otp-slashlogo">
            <img className="slashlogo" src={SBFLOGO} />
          </div>
          <div className="verificationstext">
            <div className="otpverify-text">OTP Verification</div>
