                ...
                <Form noValidate validated={validated} onSubmit={handleFormSubmit}>
                    ...
                    <Row>
                        ...
                        <div className='d-flex flex-direction-row'>
                            ...
                            <Form.Control className='p-3  fs-3' style={{width: '20%', marginLeft: 50}} disabled={!isChecked} type="text" maxLength={3} onInput={(e) => (e.target.value = e.target.value.replace(/\D/, ''))} onChange={e => setsuppVat(e.target.value)} placeholder='0%'/>                   
                        </div>
                        </Col>
                        <Col>
