...
function Productvariants(){
  ...
  const [rotatedIcons, setRotatedIcons] = useState(Array(Manufacturer.length).fill(false));
  ...
  const handleDelete = async table_id => {
    ...
    swal({
      ...
      if (willDelete) {
        try {
          const  response = await axios.delete(BASE_URL + `/manufacturer/delete/${table_id}`);
          ...
          if (response.status === 200) {
            swal({
              ...
              setManufacturer(prev => prev.filter(data => data.manufacturer_code !== table_id));
  ...
  <div className="main-of-containers">
                    ...
                    <div className="row">
                      <div className="col-6">
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                          ...
                          <Form.Control type="text" placeholder="Enter code" required value={code}
      ...
      <Modal show={updateModalShow} onHide={() => handleModalToggle()}
        ...
        <Form noValidate validated={validated} onSubmit={handleUpdateSubmit}>
          <Modal.Header closeButton>
            <Modal.Title style={{ fontSize: '24px' }}>Update Manufacturer</Modal.Title>
          </Modal.Header>
          <Modal.Body>
              <div className="gen-info" style={{ fontSize: '20px', position: 'relative' }}>
                    Manufacturer Info
                  ...
                  <Form style={{marginLeft: '10px', marginTop: '10px'}}>
                    <div className="row">
                      <div className="col-6">
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                          ...
                          value={updateFormData.manufacturer_code} readOnly onChange={handleUpdateFormChange} 
                          name="manufacturer_code" style={{height: '40px', fontSize: '15px'}}/>
                        </Form.Group>
                        </div>
                        <div className="col-6">
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                          ...
                          value={updateFormData.manufacturer_name} onChange={handleUpdateFormChange} 
                    ...
                    <Form style={{marginLeft: '10px', marginTop: '10px'}}>
                      <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                        <Form.Label style={{ fontSize: '18px' }}>Description</Form.Label>
                        <Form.Control  value={updateFormData.manufacturer_remarks} 
                        onChange={handleUpdateFormChange} name="manufacturer_remarks"
                        as="textarea" rows={3} style={{fontSize: '16px', height: '200px', maxHeight: '200px', resize: 'none', overflowY: 'auto'}} />
                      </Form.Group>
                    </Form>
          </Modal.Body>
