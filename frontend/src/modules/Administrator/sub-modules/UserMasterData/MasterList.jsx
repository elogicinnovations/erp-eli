        ...
        <div className="master-cardbody">
          ...
          <div className="tablecontains">
              ...
              <Modal show={showModal} onHide={handleClose} size="xl">
                    ...
                    <div className="row mt-3">
                      <div className="col-6">
                        <Form.Group controlId="exampleForm.ControlInput1">
                          ...
                          <Form.Control type="text" placeholder="Enter your name" style={{height: '40px', fontSize: '15px'}}/>
                        </Form.Group>
                      </div>
                      <div className="col-6">
                        <Form.Group controlId="exampleForm.ControlInput2">
                          <Form.Label style={{ fontSize: '20px' }}>Address: </Form.Label>
                          <Form.Control type="text" placeholder="Slashtech, Valenzuela City 164" style={{height: '40px', fontSize: '15px'}}/>
                        </Form.Group>
                      </div>
                    </div>
                  </Form>
                ...
                <Modal.Footer>
                  <Button variant="primary" size="md" onClick={handleClose} style={{ fontSize: '20px' }}>
                    Add
                  </Button>
            ...
            <Modal show={updateModalShow} onHide={() => handleModalToggle()} size="xl">
                <form onSubmit={handleUpdateSubmit}>
                  ...
                  <Modal.Footer>
                    ...
                    <Button variant="secondary" onClick={() => handleClose()} style={{ fontSize: '20px' }}>
                      Close
                    </Button>
                  </Modal.Footer>
                </form>
