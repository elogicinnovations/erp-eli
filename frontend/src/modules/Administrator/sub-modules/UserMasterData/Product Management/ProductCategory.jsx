...
function ProductCategory() {
    ...
    const [rotatedIcons, setRotatedIcons] = useState(Array(category.length).fill(false));
                    ...
                    <div className="main-of-all-tables">
                        <table id='order-listing'>
                                ...
                                >
                                    ...
                                    <button className='btn'  type='button' onClick={() => handleModalToggle(data)}>Update</button>
                                            <button className='btn' type='button' onClick={() => handleDelete(data.category_code)}>Delete</button>
                                </div>
                                </td>
                                          {/* <td>
