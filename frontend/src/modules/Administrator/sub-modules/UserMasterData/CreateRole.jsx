                        ...
                        <form className='w-100 mt-3' onSubmit={handleSubmit}>
                            ...
                            <div>
                              <Row>
                                ...
                                <Col>
                                  <div className='w-60 d-flex flex-column justify-content-start align-items-start align-description'>
                                    <label className='lbl_desc_rname'>Description</label>
                                    <input type="text" placeholder='Enter Description....' maxLength={200} className="form-control" name="desc" required/>
                                  </div>               
                                </Col>
                              </Row>           
                            </div>
                            ...
                            <div className='w-25 mt-5'>
                              <Row>
                                ...
                                <Col>
                                  <div>
                                    <Button variant="light border-secondary align-button-userole" onClick={handleUnselectAll}>
                                      Unselect All
                                    </Button>
                                  </div>
                                </Col>
                            ...
                            <div className='w-100 mt-1'>
                              ...
                              <Row>
                                ...
                                <Col>
                                  <div >
                                    <Button type="submit" className='btn_saveCancel' variant="primary border-secondary"  disabled = {selectedCheckboxes.length === 0}>
                                      Save
                                    </Button>
                                  </div>
