  ...
  return (
    <div className="Masterlist-main"> 
          ...
          <div className="masterlist-content">
            <div className="master-cardbody" style={{ overflowY: 'auto'}}> 
            ...
            <div className="settings-bellss-users">
              ...
              <div className="sortingplacess">
                <div className="sortingboxess">
                  <span style={{ fontSize: '20px' }}>Edit Role Profile</span>
                </div>
                  <div style={{ borderBottom: '2px solid black', width: '230%', marginRight: '10rem', marginTop: '1rem'}}></div>  
              </div>
