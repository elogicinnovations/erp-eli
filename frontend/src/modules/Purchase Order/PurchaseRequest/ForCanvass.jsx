...
function PurchaseOrderListPreview() {
  ...
  const handleCanvass = (product_id, quantity, prd_code, prd_name) => {
  ...
  const handleAddToTablePO_Assembly = (
    assemblyId,
    code,
    name,
    supp_email,
  ...
  const handleAddToTablePO_Spare = (
    spareId,
    code,
    name,
    supp_email,
  ...
  const handleAddToTablePO_Subpart = (
    subpartId,
    code,
    name,
    supp_email,
                      ...
                      <tr key={i}>
                        ...
                        <td>
                          <button
                            type="button"
                            onClick={() =>
                              handleCanvassSpare(data.spare_id, data.quantity)
                            }
                            className="btn canvas"
                          >
                            <ShoppingCart size={20} />
                        ...
                        <div className="canvassing-content-templates">
                          <div className="templates-header">
                            ...
                            <div className="SBFtextslogo">
                              ...
                              <span>
                                Email Address:{" "}
                                <strong>purchasing@sbfdrilling.com</strong>
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="templates-prname-section">
                            ...
                            <div className="template-label-value">
                              <span>{prNum}</span>
                              <span>
                                {supplierCode} - {products[0].supplierName}
                              </span>
